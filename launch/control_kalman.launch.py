...
def generate_launch_description() -> LaunchDescription:
    ...
    group = GroupAction(
        [
            ...
            Node(executable='x_controller_kalman.py',      package='position_control'),
            Node(executable='y_controller_kalman.py',      package='position_control'),
            Node(executable='z_controller_kalman.py',      package='position_control'),
